...
app.config['MYSQL_DATABASE_DB'] = 'database_kucing'
...
#     // jika gejalanya 1 langsung ketemu CF nya
        ...
        for rowpenyakitterpilih in datapenyakitterpilih:
            if (j>=i):
                if (list_daftar_cf[j] > list_daftar_cf[i]):
                    ...
                    tttt = list_daftar_solusi_penyakit[i]
                    list_daftar_solusi_penyakit[i] = list_daftar_solusi_penyakit[j]
                    list_daftar_solusi_penyakit[j] = tttt
    ...
    return render_template('proses-cf-flask-mysql.html', sql=sql, html=html, list_gejala_terpilih=list_gejala_terpilih, list_daftar_cf=list_daftar_cf, list_daftar_penyakit=list_daftar_penyakit, list_daftar_id_penyakit=list_daftar_id_penyakit, list_daftar_solusi_penyakit=list_daftar_solusi_penyakit)
